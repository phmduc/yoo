...
<body <?php body_class(); ?>>
	...
	<main id="main" class="<?= (is_page_template('page-full.php')) || (is_page_template('page-blog.php')) || (is_page_template('page-fish.php'))  || (is_page_template('page-gambling.php')) || (is_page_template('page-sport.php')) || (is_page_template('page-slots.php')) || (is_page_template('page-fightchicken.php')) || (is_page_template('page-casino.php')) || (is_page_template('page-lottery.php')) || (is_page_template('archive.php')) || (is_page_template('category.php')) || (is_page_template('page-adviser.php')) ? 'w-builder' : 'container' ?>" <?php if ( isset( $navbar_position ) && 'fixed_top' === $navbar_position ) : echo ' style="padding-top: 57px;"'; elseif ( isset( $navbar_position ) && 'fixed_bottom' === $navbar_position ) : echo ' style="padding-bottom: 100px;"'; endif; ?>>
		<?php
